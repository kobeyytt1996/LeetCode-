      ...
      1. 无向连通图:
            ...
            1. 深度优先搜索：题133. 克隆图（BFS和DFS都可以）
            		...
            		2. 有向图（无向图从哪一端都可以开始，有向图只能从起始方向）：
             		1. BFS：**题207. 课程表**（看[高赞](https://leetcode-cn.com/problems/course-schedule/solution/course-schedule-tuo-bu-pai-xu-bfsdfsliang-chong-fa/)。即判断是否是无环图。本质即先修能修的，然后逐步解锁，最后看能否修完。因为可以初始修的课程有多门，所以BFS更易理解且好做。DFS还得考虑同一节点是否被多条路径经过）
