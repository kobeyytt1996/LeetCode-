...
5. 链表：
   ...
   1. 单链表：
      ...
      3. 遍历：题61. 旋转链表（简单题一定要一次做对）、**题82**、83. 删除排序链表中的重复元素 II（*82易错。注意和面试官沟通，为了简化，没有释放被删除链表节点的内存空间）、题147. 对链表进行插入排序（易错。要移除节点，就一定要记录其前一个节点）、题203. 移除链表元素、题206. 反转链表
...
7. 数字：
   ...
   5. 双指针：**题202. 快乐数**（[关键在于对题目的分析](https://leetcode-cn.com/problems/happy-number/solution/kuai-le-shu-by-leetcode-solution/)，得到要么会陷入值重复的循环要么会得到1，有值重复循环的问题就想到用快慢双指针来验证。类似单链表）
